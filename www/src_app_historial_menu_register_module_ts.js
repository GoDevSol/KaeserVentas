...
let RegisterPage = class RegisterPage {
    constructor(modalCtrl, navCtrl, api) {
    ...
    ngOnInit() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__awaiter)(this, void 0, void 0, function* () {
            var user = yield this.api.getDBItem("User");
            this.user = user;
