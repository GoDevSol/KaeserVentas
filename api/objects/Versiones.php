...
class Versiones extends CRUD
{

    // DB connection y table name
    public $conn;
    public $table_name = "Versiones";
    ...
    public function getByEstadoC4C()
    {
        return $this->_read("*", "estadoC4C=", "", $this, "");
    }
    ...
    public function createVersiones()
    {
        $insertParams = "idCotizacion,datosForm,datosModelos,direccionArchivo,estado,estadoC4C,Date";
    ...
    function updateByEstadoC4C()
    {
        $updateParams = $this->createParams($this, "estadoC4C");

        $whereParams = "estadoC4C=";
